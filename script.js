...
async function consultarIA() {
    ...
    container.innerHTML = '<div class="loader-ia" style="margin:20px auto; border:4px solid rgba(255,255,255,0.1); border-top:4px solid #ffd700; border-radius:50%; width:40px; height:40px; animation:spin 1s linear infinite;"></div>';
